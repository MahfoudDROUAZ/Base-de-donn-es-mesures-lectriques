...
Mesures de tension/courant:
	...
	- Type appareil : ventillateur à 2 vitesses de marque CELCIA
	- Caractéristiques : 35W, 220-240V~ 50Hz
...
- capteur de courant2: capteur ACS 723 20A output = 100mV/A
- CAN : labjack U3HV +/-10V tension et courant

*************************************************************************************************

Nomination du fichier : "data _ventillateur_2_vitesse(1/2)_15KHz_mesureX.mat"
