...
Mesures de tension/courant:
	...
	- Type de mesure : ON/OFF d'une lampe néom
	- Type appareil : lampe à néon avec loupe
	- Caractéristiques : 2x9 watts, courant, tension ... etc **
...
Nomination du fichier : "data _lampeNeon_1_20KHz_mesureX.mat"

Contenu du fichier.mat

Temps  |  tension  |  courant

Temps de mise en marche = 4 secondes
...
Pour obtenir les bonnes valeurs dans les Fichiers.dat, il faut:
	...
	- Tension : doit être multiplier par le facteur de la sonde différentielle utilisée.
